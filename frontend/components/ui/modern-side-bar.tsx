...
function workspaceNavItems(role: string): NavigationItem[] {
  const items: NavigationItem[] = [
    { id: "ws-overview", name: "Overview", icon: LayoutDashboard, href: "/workspace" },
    { id: "ws-trends", name: "Trends", icon: LineChart, href: "/workspace/trends" },
    { id: "ws-map", name: "Map", icon: MapPin, href: "/workspace/map" },
    { id: "ws-reports", name: "Reports", icon: FileText, href: "/workspace/reports" },
  ];
  ...
  if (role === "ADMIN") {
    items.push({ id: "ws-team", name: "Team", icon: Users, href: "/workspace/team" });
  }
...
function navigationForUser(role: string | undefined | null): NavigationItem[] {
  if (!role) {
    return [
      { id: "portal", name: "Home", icon: Home, href: "/" },
      {
        id: "medical",
  ...
  if (role === "ADMIN") {
    return workspaceNavItems("ADMIN");
  }

  return [{ id: "portal", name: "Home", icon: Home, href: "/" }, ...workspaceNavItems(role)];
}
  ...
  return (
    <div className="flex min-h-screen w-full bg-slate-50 md:h-screen md:overflow-hidden">
      <Button
        ...
        className="fixed top-6 left-6 z-50 rounded-lg border-slate-100 shadow-md md:hidden"
      ...
      >
        <div
          className={`flex items-center border-b border-slate-200 bg-emerald-50/50 p-5 ${
        ...
        >
          {!isCollapsed && (
            <div className="flex items-center space-x-2.5">
              ...
              <div className="flex flex-col">
                <span className="text-base font-semibold text-slate-800">JanSetu</span>
          ...
          <Button
            ...
            className="hidden shrink-0 rounded-md md:flex"
          ...
          <div className="px-4 py-3">
            <div className="relative">
              ...
              <Input
                type="search"
                placeholder="Search..."
                className="border-slate-200 bg-slate-50 py-2 pr-4 pl-9 placeholder:text-slate-400 focus-visible:border-transparent focus-visible:ring-emerald-500"
              />
            </div>
          </div>
        )} */}
          ...
          <div className="p-3">
            {user ? (
              <Button
                ...
                className={`group relative w-full text-slate-600 hover:bg-emerald-50 hover:text-emerald-800 ${
                  isCollapsed ? "justify-center px-2" : "justify-start"
                }`}
              >
                <LogOut className="text-slate-500 group-hover:text-emerald-700" />
              ...
              <Button
                ...
                className={`group relative w-full text-emerald-700 hover:bg-emerald-50 hover:text-emerald-800 ${
                  isCollapsed ? "justify-center px-2" : "justify-start"
                }`}
              >
                <Link
                ...
                >
                  <LogIn className="text-emerald-600 group-hover:text-emerald-700" />
